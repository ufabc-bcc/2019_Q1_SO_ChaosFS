...
void preenche_bloco (int isuperbloco, const char *nome, mode_t direitos, nlink_t links, uint16_t tamanho, uint16_t bloco, const byte *conteudo);


static int getattr_chaosfs(const char *path, struct stat *stbuf, struct fuse_file_info *fi);
